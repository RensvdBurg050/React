...
//             <button
//             onClick={addTodo}
//             className='bg-blue-500 text-white px-4 py-2 rounded-r-lg hover:bg-blue-600 transition-colors cursor-pointer'
//             >
//           Add
//             </button>
//           </div>
...
//           </ul>
//           {todos.length === 0 && (
//             <p className='text-center text-gray-500 mt-4'>Er staan geen ToDo's open!</p>
//           )}
//         </div>
//       </div>
//     </div>
